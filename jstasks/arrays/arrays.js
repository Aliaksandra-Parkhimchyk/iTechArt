...
var binaryConverter = {
    ...
    conversionFromDecimalToBinary: function (array) {
        ...
        /*
         „то-то непон€тное происходит, зачем передавать число разбитым и
        ...
        // тут не мог пон€ть как в результате сложени€ чисел получаетс€ строка ))), но это правильно ты сделала.
    ...
    conversionFromBinaryToDecimal: function (array) {
        ...
        // ј как можно всю эту функцию в 1 строку записать, юза€ функции JS?
